...
export default function WorkshopPage() {
  const events = EVENT_CATALOG.filter((e) => e.type.toLowerCase().includes("workshop"));
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground font-sans selection:bg-[#CCFBF1] selection:text-[#0D9488]">
      ...
      <main className="flex-1 pb-24 lg:pb-16 space-y-12">
          ...
          <div className="container-lg relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-[360px] md:min-h-[460px]">
            <div className="space-y-6 lg:pr-8 py-12 md:py-20">
              ...
              <p className="text-base md:text-[17px] text-[#64748B] max-w-lg leading-relaxed">
                Sesi workshop melalui Zoom Meeting bersama praktisi kesehatan mental untuk membantumu memahami diri dan mendapatkan solusi praktis.
              </p>
              <div className="pt-2">
                <a
                  href="#workshop-grid"
                ...
                >
                  <span>Lihat Jadwal Workshop</span>
        ...
        {/* Catalog Grid */}
        <div id="workshop-grid" className="container-lg my-12 space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#0F172A]">
              Daftar Workshop Interaktif
            </h2>
            <p className="text-sm md:text-base text-[#64748B] max-w-xl mx-auto">
              Ikuti sesi pelatihan praktis bersama Psikolog &amp; Fasilitator Berlisensi.
            </p>
          </div>
            ...
            {events.map((event) => (
              ...
              >
                ...
                <div className="p-5 border-t border-gray-100 flex items-center justify-between">
                  <div>
                    <div className="text-xs text-[#64748B] font-medium font-medium">Mulai Dari</div>
